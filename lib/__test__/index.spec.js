...
describe("mdLinks", () => {
  ...
  it("testando com erro do fs", () => expect(mdLinks("directory", { validate: false })).rejects.toMatch("File not found Error: ENOENT: no such file or directory, open 'directory'"));
});
